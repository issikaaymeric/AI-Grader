        ...
        *,
        ...
        Args:
          ...
          messages: Input messages.
              ...
              [system ](https://docs.anthropic.com/en/docs/system-s), you can use
              the top-level `system` parameter — there is no `"system"` role for input
              messages in the Messages API.

          model: The model that will complete your .
          ...
          system: System .
              ...
              A system  is a way of providing context and instructions to Claude, such
              as specifying a particular goal or role. See our
              [guide to system s](https://docs.anthropic.com/en/docs/system-s).
